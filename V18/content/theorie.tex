...
Der Intensitätsverlust des $\gamma$-Strahls hängt von der Schichtdicke $D$ des Absorbers, der Zahl $n$ der Elektronen pro Volumeneinheit und dem Wirkungsquerschnitt $\sigma$ ab mit
\begin{equation}
\label{eq:Absorbtion}
...
Der Wirkungsquerschnitt des Photoeffekts ist stark von der Kernladungszahl und der Energie der $\gamma$-Quanten abhängig
\begin{equation*}
...
\end{equation}
Hier ist $m_{\symup{e}}$ die Masse des Elektrons, $c$ die Lichtgeschwindigkeit und $\Psi_{\gamma}$ der Streuwinkel $\Psi_{\gamma}$ des gestreuten $\gamma$-Quants.
...
Damit dieser Prozess (vom Ruhesystem des $\gamma$-Quants ausgehend) stattfinden kann muss zusätzlich noch ein Stoßpartner vorhanden sein.
...
Das Compton-Kontinuum reicht, durch die verschiedenen Streuwinkel der $\gamma$-Quanten, von der Energie 0 bis zur Compton-Kante $E_{\symup{e},\symup{max}}$ bei $\Psi{\gamma}=\SI{180}{\degree}$, mit
\begin{equation}
\label{eqn:Com_Kante}
