...
werden mit den theoretischen Werten \cite{referenz2} verglichen, sodass mit Hilfe einer linearen Ausgleichsrechnung
eine Zuordnung von Kanal und Energie möglich ist. Diese Daten sind
...
\begin{equation}
  \frac{E_{\sfrac{1}{10}}}{E_{\sfrac{1}{2}}} = \frac{\sqrt{8 \cdot \log{(10)}} \cdot \sigma_\text{fit}}{\sqrt{8 \cdot \log{(2)}} \cdot \sigma_\text{fit}} = \frac{\log{(10)}}{\log{(2)}} = \num{1.823}
\end{equation}
...
Die Emissionswahrscheinlichkeiten werden der Referenz \cite{referenz2} entnommen um damit die Aktivität zu bestimmen. 
