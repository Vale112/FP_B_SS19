...
\begin{figure}[htb]
  ...
  \label{fig:cdblau}
\end{figure}
In Tabelle \ref{tab:Lande_rot} sind die theoretisch berechneten Landé-Faktoren für den Übergang $^1P_1 \leftrightarrow ^1\!\!D_2$,
...
\input{content/tables/Eichung.tex}
\begin{figure}[htb]
  \centering
