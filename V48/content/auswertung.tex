...
\begin{align*}
    ...
    &\overline{+ \left(\frac{\symup{k_B} T_\text{max}^2}{h} \exp\left(-\frac{W}{\symup{k_B} T_\text{max}}\right)\left(\frac{1}{\symup{k_B}T_\text{max}W} + \frac{1}{W^2} \right) \Delta W \right)^2} \\ 
    &\overline{+ \left(\frac{\symup{k_B} T_\text{max}^2}{W h^2} \exp\left(-\frac{W}{\symup{k_B} T_\text{max}}\right)\Delta h \right)^2}.
\end{align*}
